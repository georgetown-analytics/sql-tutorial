...
If you'd like to work directly with the iPython Notebook, you can clone this repository, download the zip, or simply download `Workshop.ipynb`. Once you have it, you can run iPython notebook as follows:

    $ ipython notebook Workshop.ipynb

Note if you don't hae ipython, you can pip install it:
